...
APK/AAB 版本：2.1.127 (20127)

### Windows 与 Android 测试版更新内容

标题：看影音 2.1.127 测试版

- 本地媒体库、网盘媒体库以及电影、动漫、电视剧三个入口统一只显示本地资源和已启用的网盘来源，停用来源不会再混入分类页造成重复或“分类有、网盘没有”的卡片。
- 未刮削的同名网盘作品按作品键分组，与网盘媒体库海报墙保持一致；TMDB 手动匹配仍按作品身份合并，并继续显示对应季度海报。
- 电影、动漫、电视剧三个入口的海报操作菜单新增“媒体详情”，本地和网盘资源均可查看来源、媒体类型、季度、集数、总大小、评分、类型标签、文件名、路径、格式、日期和字幕状态。
- 分类入口继续保留统一海报浮窗、海报操作菜单、播放、复制路径和隐藏能力，网盘多集或多版本资源的总大小和最新日期仍按全部视频汇总。
- Windows 与 Android 版本继续使用统一版本配置，诊断日志继续脱敏并隐藏本地文件路径。
- 已安装 2.1.126.0 的用户可直接升级到 2.1.127.0。
