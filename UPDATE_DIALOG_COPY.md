...
看影音 Android 2.1.203 测试版

- 修复 Android 部分资源在分类详情和网盘选集面板中不显示 4K、来源、编码等技术规格标签的问题，并优先使用资源已保存的结构化标签。继续支持本地媒体库、个人网盘、字幕、音轨、后台播放、画中画、MediaCodec 硬件解码和 Anime4K。
- 本次更新不会修改、删除、改名或移动本地及个人网盘原始视频、字幕和海报缓存。
