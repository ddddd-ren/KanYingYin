...
- 应用版本：2.1.140
- Windows EXE 安装器版本：2.1.140 测试版
- 本轮交付：Windows 测试版 EXE；Android 测试版 APK/AAB
- Android 应用版本：2.1.140
- Android versionCode：20140
- 日期：2026-08-07
...
看影音 Android 2.1.140 测试版

- 修复 Android TV 本地媒体库路径输入框捕获方向键的问题，按左键可以回到侧边导航栏。
- TV 输入框按方向键时优先执行焦点导航，Windows 和普通 Android 保留文本编辑行为。
