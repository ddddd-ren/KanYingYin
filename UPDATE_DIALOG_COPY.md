...
看影音 Android 2.1.202 测试版

- Android 2.1.202 测试版取消手机和平板海报墙上的常驻信息浮窗；点击网盘资源或分类海报统一进入底部媒体详情/选集界面，在详情中查看简介、技术信息和资源明细后再播放。继续支持本地媒体库、个人网盘、字幕、音轨、后台播放、画中画、MediaCodec 硬件解码和 Anime4K。
- 本次更新不会修改、删除、改名或移动本地及个人网盘原始视频、字幕和海报缓存。
