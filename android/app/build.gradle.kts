...
if (windowsVersionName != "1.0.12" || windowsVersionCode != 10012) {
    throw GradleException("pubspec.yaml 必须为 Windows 正式版 1.0.12+10012")
}
val androidVersionName = "1.0.8"
val androidVersionCode = 10008
