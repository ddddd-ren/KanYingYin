...
if (windowsVersionName != "2.1.205" || windowsVersionCode != 20205) {
    throw GradleException("pubspec.yaml 必须为 Windows 测试版 2.1.205+20205")
}
val androidVersionName = "2.1.205"
val androidVersionCode = 20205
