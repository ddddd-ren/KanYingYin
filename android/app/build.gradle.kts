...
if (windowsVersionName != "2.1.199" || windowsVersionCode != 20199) {
    throw GradleException("pubspec.yaml 必须为 Windows 测试版 2.1.199+20199")
}
val androidVersionName = "2.1.199"
val androidVersionCode = 20199
