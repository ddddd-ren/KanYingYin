...
if (windowsVersionName != "2.1.200" || windowsVersionCode != 20200) {
    throw GradleException("pubspec.yaml 必须为 Windows 测试版 2.1.200+20200")
}
val androidVersionName = "2.1.200"
val androidVersionCode = 20200
