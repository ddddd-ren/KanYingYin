...
if (windowsVersionName != "2.1.202" || windowsVersionCode != 20202) {
    throw GradleException("pubspec.yaml 必须为 Windows 测试版 2.1.202+20202")
}
val androidVersionName = "2.1.202"
val androidVersionCode = 20202
