...
if (windowsVersionName != "2.1.203" || windowsVersionCode != 20203) {
    throw GradleException("pubspec.yaml 必须为 Windows 测试版 2.1.203+20203")
}
val androidVersionName = "2.1.203"
val androidVersionCode = 20203
