...
- Dart 格式：`680` 个文件检查完成，`0` 个文件需要修改。
- Flutter 测试：`1799/1799` 通过。
...
- 独立验证摘要：`tool/android/private-output/tv-test-20260807-121834-summary.json`，该目录为本机私有输出，不提交到仓库。
...
| 旧 Windows MSIX | 已发现 | 桌面和 Release 目录仍存在历史 MSIX 文件，但本轮未生成或交付 MSIX |
