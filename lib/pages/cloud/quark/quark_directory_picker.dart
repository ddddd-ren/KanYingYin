...
class QuarkDirectoryPickerPage extends StatefulWidget {
  ...
  @override
  State<QuarkDirectoryPickerPage> createState() =>
      _QuarkDirectoryPickerPageState();
}

class _QuarkDirectoryPickerPageState extends State<QuarkDirectoryPickerPage> {
  ...
  void initState() {
    ...
    for (final reference in widget.initialSelection) {
      _selected[_key(reference)] = reference;
    }
    WidgetsBinding.instance.addPostFrameCallback((_) => _load(_current));
  }

  Future<void> _load(CloudRemoteRef directory,
      {bool pushHistory = false}) async {
    setState(() {
      _loading = true;
      _errorMessage = null;
    });
  ...
  void _toggle(CloudRemoteRef reference, bool selected) {
    setState(() {
      ...
      if (selected) {
        ...
        _selected.remove(_key(reference));
      }
    });
  }
        ...
        children: [
          ListTile(
            ...
            trailing: Checkbox(
              ...
              value: _selected.containsKey(_key(_current)),
              onChanged: _loading
                  ? null
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  trailing: Checkbox(
                    ...
                    value: _selected.containsKey(_key(reference)),
                    onChanged: _loading
                        ? null
  ...
  static String _key(CloudRemoteRef reference) =>
