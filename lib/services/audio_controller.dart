...
class AudioController {
  ...
  Future<void> _initialize() async {
    ...
    await AudioService.init(
      ...
      config: const AudioServiceConfig(
        androidNotificationChannelId: 'com.kanyingyin.player.channel.audio',
        androidNotificationChannelName: '看影音播放',
  ...
  Future<void> _safePause() async {
    try {
      ...
      AppLogger().w('AudioController: interruption pause failed', error: e);
    }
  }
  ...
  Future<void> _safePlay() async {
    try {
      ...
      AppLogger().w('AudioController: interruption resume failed', error: e);
    }
  }
  ...
  Future<void> _setAudioSessionActive(bool active) async {
    ...
    try {
      ...
      AppLogger().w('AudioController: setActive($active) failed', error: e);
    }
  }
