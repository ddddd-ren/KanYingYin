...
class PipUtils {
  ...
  static Future<bool> isAndroidPIPSupported() async {
    ...
    const pipChannel = MethodChannel('com.kanyingyin.player/pip');
    try {
      final bool? supported =
          await pipChannel.invokeMethod('isPictureInPictureSupported');
      return supported ?? false;
    } on PlatformException catch (e) {
      AppLogger().e("Failed to check Android PIP support: '${e.message}'.");
      return false;
    }
  }
  ...
  static Future<bool> enterAndroidPIPWindow(
    ...
    try {
      ...
      AppLogger().e("Failed to enter Android PIP mode: '${e.message}'.");
      return false;
    }
  }
  ...
  static Future<void> updateAndroidPIPActions({
    ...
    try {
      ...
      AppLogger().e("Failed to update Android PIP actions: '${e.message}'.");
    }
  }
  ...
  static Future<void> setAndroidPIPInPlayerPage(bool inPlayerPage) async {
    ...
    try {
      ...
      AppLogger().e("Failed to set Android PIP page state: '${e.message}'.");
    }
  }
  ...
  static void initPipHandler({
    ...
    const MethodChannel pipChannel = MethodChannel('com.kanyingyin.player/pip');
