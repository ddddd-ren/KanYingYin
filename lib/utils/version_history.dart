...
const List<VersionHistory> versionHistoryList = [
  ...
  VersionHistory(
    ...
    isPrerelease: true,
    changes: [
      '本测试版修复夸克默认转存目录已保存、手动扫描却仍可能漏掉其中视频的问题',
  ...
  VersionHistory(
    ...
    isPrerelease: true,
    changes: [
      '本测试版修复在夸克来源设置中选择默认转存目录后，手动扫描仍可能漏掉该目录视频的问题',
  ...
  VersionHistory(
    ...
    isPrerelease: true,
    changes: [
      '本测试版修复夸克网盘所有视频统一提示“网盘视频解析或加载失败”的问题，改用真实可用的原文件播放地址',
  ...
  VersionHistory(
    ...
    isPrerelease: true,
    changes: [
      '本测试版修复夸克网盘视频进入播放器后持续加载，并提示“播放地址不可用”的问题',
