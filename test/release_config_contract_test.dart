...
void main() {
  test('当前发布配置为 Windows 和 Android 二点一四二测试版', () {
    ...
    final currentReleaseNotes = releaseNotes.substring(
      releaseNotes.indexOf('## 2.1.142+20142'),
    ...
    expect(currentReleaseNotes, contains('2.1.142'));
    ...
    expect(updateDialogCopy, contains('2.1.142'));
    expect(updateDialogCopy, contains('2.1.142'));
  });
