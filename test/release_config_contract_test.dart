...
void main() {
  test('当前发布配置为 Windows 和 Android 二点一四三测试版', () {
    ...
    expect(updateDialogCopy, contains('2.1.143'));
    expect(updateDialogCopy, contains('2.1.143'));
  });
