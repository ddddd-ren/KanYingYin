...
$androidVersion = '2.1.96'
$androidVersionCode = 20196
$requiredVariables = @(
...
try {
    ...
    if ($windowsVersion -ne '2.1.96' -or $windowsBuildNumber -ne '20196') {
        throw "Windows pubspec 版本必须为 2.1.96+20196，实际为 $windowsVersion+$windowsBuildNumber"
    }
