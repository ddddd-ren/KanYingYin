...
if ($pubspecVersion.Name -ne '2.1.200' -or $pubspecVersion.Code -ne 20200) {
    throw 'pubspec.yaml must use Windows test version 2.1.200+20200'
}
$androidVersion = '2.1.200'
$androidVersionCode = 20200
$requiredVariables = @(
