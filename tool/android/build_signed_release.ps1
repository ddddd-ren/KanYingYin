...
if ($pubspecVersion.Name -ne '2.1.164' -or $pubspecVersion.Code -ne 20164) {
    throw "Windows pubspec 版本必须为 2.1.164+20164，实际为 $($pubspecVersion.Name)+$($pubspecVersion.Code)"
}
$androidVersion = '2.1.164'
$androidVersionCode = 20164
$requiredVariables = @(
