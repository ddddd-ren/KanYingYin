...
if ($pubspecVersion.Name -ne '2.1.159' -or $pubspecVersion.Code -ne 20159) {
    throw "Windows pubspec 版本必须为 2.1.159+20159，实际为 $($pubspecVersion.Name)+$($pubspecVersion.Code)"
}
$androidVersion = '2.1.159'
$androidVersionCode = 20159
$requiredVariables = @(
