...
if ($pubspecVersion.Name -ne '2.1.162' -or $pubspecVersion.Code -ne 20162) {
    throw "Windows pubspec 版本必须为 2.1.162+20162，实际为 $($pubspecVersion.Name)+$($pubspecVersion.Code)"
}
$androidVersion = '2.1.162'
$androidVersionCode = 20162
$requiredVariables = @(
