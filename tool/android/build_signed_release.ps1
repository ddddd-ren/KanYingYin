...
if ($pubspecVersion.Name -ne '2.1.165' -or $pubspecVersion.Code -ne 20165) {
    throw "Windows pubspec 版本必须为 2.1.165+20165，实际为 $($pubspecVersion.Name)+$($pubspecVersion.Code)"
}
$androidVersion = '2.1.165'
$androidVersionCode = 20165
$requiredVariables = @(
