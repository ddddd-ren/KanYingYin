...
$androidVersion = '2.1.97'
$androidVersionCode = 20197
$requiredVariables = @(
...
try {
    ...
    if ($windowsVersion -ne '2.1.97' -or $windowsBuildNumber -ne '20197') {
        throw "Windows pubspec 版本必须为 2.1.97+20197，实际为 $windowsVersion+$windowsBuildNumber"
    }
