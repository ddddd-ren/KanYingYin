...
if ($pubspecVersion.Name -ne '2.1.166' -or $pubspecVersion.Code -ne 20166) {
    throw "Windows pubspec 版本必须为 2.1.166+20166，实际为 $($pubspecVersion.Name)+$($pubspecVersion.Code)"
}
$androidVersion = '2.1.166'
$androidVersionCode = 20166
$requiredVariables = @(
