...
if ($pubspecVersion.Name -ne '2.1.163' -or $pubspecVersion.Code -ne 20163) {
    throw "Windows pubspec 版本必须为 2.1.163+20163，实际为 $($pubspecVersion.Name)+$($pubspecVersion.Code)"
}
$androidVersion = '2.1.163'
$androidVersionCode = 20163
$requiredVariables = @(
